...
<body>
	...
	<form id='formdata' role='form' action='add' role='form' method='post'>
		<textarea id='formarea' name=content class=form-control rows='10' cols='35' placeholder='내용을 추가해주세요!'></textarea>
		<input id='formurl' name=url class=form-control type='text'  placeholder='이미지URL or 유투브 URL'>
		<input id='formid' name=id class=form-control type='text'  placeholder='아이디'>
		<input id='formpassword' name=password class=form-control type='password'  placeholder='비밀번호'>
...
(List<Board>)request.getAttribute("boardList");
...
<%} %>
	...
	<footer></br>@bit.co.kr 윤용식,김광철,김원기</footer>
